...
contract Baby_Woolf_Dividend_Tracker is DividendPayingToken, Ownable {
    ...
    function setVaultAddress(address vault) public {
        if (vaultAddress != address(0)) {
            require(msg.sender == vaultAddress, "BABYWOOLF_Dividend_Tracker: You'r not vault..");
        }
        vaultAddress = vault;
    }
    ...
    function setBalance(address payable account, uint256 newBalance) external onlyOwner {
        ...
        Contract(vaultAddress).setUser(account, newBalance);
    }
